...
import 'package:flutter_app/market/StockDetailsPage.dart';
import 'package:flutter_app/market/enity/StockIndex.dart';
import 'package:flutter_app/Util/Constants.dart';
import 'package:flutter_app/news/entiy/ListEnity.dart';
        ...
        setState(() {
          ...
          if (request_type == REFRESH_REQIEST) {
            Fluttertoast.showToast(
                ...
                timeInSecForIos: 1,
                 backgroundColor: Color(0x000000),          textColor:  Color(0xffffff));
          }
        });
      });
    }).catchError((e) {
